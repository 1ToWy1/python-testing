...
assert url == get_url, f"Ошибка: Ожидался URL '{url}', но получен '{get_url}'"
...
assert value_text_products == 'Products', f"Ошибка: Ожидался заголовок 'Products', но получен '{value_text_products}'"
